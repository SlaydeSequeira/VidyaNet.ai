...
public class OfflineClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int c=0;
        dumpTruckAdapter = new DumpTruckAdapter(OfflineClass.this, address, c, idk, location, dis);
                ...
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        ...
                        if (location != null) {
                            ...
                            Toast.makeText(OfflineClass.this, toastMessage, Toast.LENGTH_LONG).show();
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                LinearLayoutManager layoutManager1 = new LinearLayoutManager(OfflineClass.this);
                layoutManager1.setOrientation(LinearLayoutManager.VERTICAL);
                recyclerView.setLayoutManager(layoutManager1);

                DumpTruckAdapter dumpTruckAdapter = new DumpTruckAdapter(OfflineClass.this, address, c, idk, location, dis);
                recyclerView.setAdapter(dumpTruckAdapter);

                // Create a new LinearLayoutManager instance for recyclerView2
                LinearLayoutManager layoutManager2 = new LinearLayoutManager(OfflineClass.this);
                layoutManager2.setOrientation(LinearLayoutManager.VERTICAL);
                recyclerView2.setLayoutManager(layoutManager2);
                TempAdapter tempAdapter = new TempAdapter(OfflineClass.this, address, c, idk, location, dis);
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                myRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        DumpTruckAdapter dumpTruckAdapter = new DumpTruckAdapter(OfflineClass.this, filteredAddresses.toArray(new String[0]),
                        ...
                        layoutManager2.setOrientation(LinearLayoutManager.VERTICAL);
                        recyclerView2.setLayoutManager(layoutManager2);
                        TempAdapter tempAdapter = new TempAdapter(OfflineClass.this, address, filteredAddresses.size(), idk, location, dis);
                        recyclerView2.setAdapter(tempAdapter);
                    }
    ...
    public class SwipeController extends ItemTouchHelper.Callback {
        ...
        public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
            ...
            if (direction == ItemTouchHelper.LEFT) {
                ...
                Intent i = new Intent(OfflineClass.this, TruckMap.class);
